...
extra_cflags=-m64 -D__NR_userfaultfd=323
extra_ldflags=
qemu_localedir=${prefix}/share/locale
libs_softmmu=-lpixman-1  -lutil -lncurses    -lfdt
ARCH=x86_64
STRIP=strip
CONFIG_POSIX=y
CONFIG_LINUX=y
...
VERSION=2.2.92
PKGVERSION=
SRC_PATH=/home/kashif/Downloads/qemu
...
CFLAGS_NOPIE=
QEMU_CFLAGS=-I/usr/include/pixman-1   -Werror -fPIE -DPIE -m64 -D_GNU_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -Wstrict-prototypes -Wredundant-decls -Wall -Wundef -Wwrite-strings -Wmissing-prototypes -fno-strict-aliasing -fno-common -D__NR_userfaultfd=323  -Wendif-labels -Wmissing-include-dirs -Wempty-body -Wnested-externs -Wformat-security -Wformat-y2k -Winit-self -Wignored-qualifiers -Wold-style-declaration -Wold-style-definition -Wtype-limits -fstack-protector-strong
QEMU_INCLUDES=-I$(SRC_PATH)/tcg -I$(SRC_PATH)/tcg/i386 -I$(SRC_PATH)/linux-headers -I/home/kashif/Downloads/qemu/linux-headers -I. -I$(SRC_PATH) -I$(SRC_PATH)/include
AUTOCONF_HOST := 
