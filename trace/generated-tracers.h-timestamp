...
static inline void trace_ram_find_and_save_block_postcopy(const char * block_name, uint64_t tmp_offset, uint64_t ram_addr)
{
}

static inline void trace_ram_find_and_save_block_postcopy_not_dirty(const char * block_name, uint64_t tmp_offset, uint64_t ram_addr, int sent)
{
}
...
static inline void trace_migrate_fd_cleanup_src_rp(void)
{
}
...
static inline void trace_migration_thread_end_of_iteration_file_err(void)
{
}

static inline void trace_migration_thread_end_of_iteration_postcopy_end(void)
{
}

static inline void trace_migration_thread_end_of_iteration_postcopy_end_after_complete(void)
{
}

static inline void trace_migration_thread_end_of_iteration_postcopy_end_before_rp(void)
{
}

static inline void trace_migration_thread_end_of_iteration_postcopy_end_after_rp(int rp_error)
{
}
...
static inline void trace_source_return_path_thread_failed_read_cmd_data(void)
{
}
...
static inline void trace_postcopy_cleanup_area(const char * ramblock, void * host_addr, size_t offset, size_t length)
{
}

static inline void trace_postcopy_ram_discard_range(void * start, void * end)
{
}

static inline void trace_postcopy_init_area(const char * ramblock, void * host_addr, size_t offset, size_t length)
{
}

static inline void trace_postcopy_place_page(void * host_addr, bool all_zero)
{
}
